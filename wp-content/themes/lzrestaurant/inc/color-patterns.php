 ...
 */
function lzrestaurant_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );
	$saturation = absint( apply_filters( 'lzrestaurant_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.lzrestaurant-front-page) .entry-title,
...
.colors-custom .lzrestaurant-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.lzrestaurant-front-page .panel-content .recent-posts article,
...
.colors-custom.lzrestaurant-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters lzrestaurant custom colors CSS.
	 *
	 * @since lzrestaurant 1.0
	 *
	 * @param string $css        Base theme colors CSS.
	 * @param int    $hue        The user's selected color hue.
	 * @param string $saturation Filtered theme color saturation level.
	 */
	return apply_filters( 'lzrestaurant_custom_colors_css', $css, $hue, $saturation );
}
